...
public class MegaFlowEditor : Editor
{
	...
	public void OnSceneGUI()
	{
		...
		{
			case MegaFlowAxis.X:
				mod.handlepos = Handles.FreeMoveHandle(mod.handlepos, Quaternion.identity, mod.flow.spacing.x * scale.x, Vector3.zero, Handles.SphereCap);
			...
			case MegaFlowAxis.Y:
				mod.handlepos = Handles.FreeMoveHandle(mod.handlepos, Quaternion.identity, mod.flow.spacing.y * scale.y, Vector3.zero, Handles.SphereCap);
			...
			case MegaFlowAxis.Z:
				mod.handlepos = Handles.FreeMoveHandle(mod.handlepos, Quaternion.identity, mod.flow.spacing.z * scale.z, Vector3.zero, Handles.SphereCap);
